...
const CertificationsAndAssessments = () => {
  ...
  return (
    <div className="bg-white flex justify-center pt-16 pb-6">
      <div className="max-w-7xl w-full">
        <section className="mb-16">
          <h2
            className="text-[#6433F6] font-bold text-[40px] text-center mb-6">
            Certifications
          </h2>
          <div className="flex flex-wrap justify-center gap-3">
            {certifications.map((cert, index) => (
              ...
              >
                <span className="block rounded-full px-4 py-2 text-xs font-semibold text-black bg-white">
                  {cert}
                </span>
              </span>
            ))}
